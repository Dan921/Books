...
namespace Data.Migrations
{
    ...
    [Migration("20210408065006_added_change_entities")]
    partial class added_change_entities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Context.BookChange", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("ChangedBookId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("CheckingId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Data.Context.BookRent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Data.Context.UserFavoriteBook", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Data.Context.BookChange", b =>
                {
                    b.HasOne("Data.Context.Book", "Book")
                        .WithMany()
                        .HasForeignKey("BookId");

                    b.HasOne("Data.Context.Book", "ChangedBook")
                        .WithMany()
                        .HasForeignKey("ChangedBookId");

                    b.Navigation("Book");

                    b.Navigation("ChangedBook");
                });
            ...
            modelBuilder.Entity("Data.Context.BookRent", b =>
                {
                    ...
                    b.HasOne("Data.Context.AppUser", "User")
                        .WithMany()
